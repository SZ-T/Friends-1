...
// Search for friends matching the search statement (all friends if empty)
$friendDataSet = new FriendsDataSet();
$data = $friendDataSet->searchUsers($view->searchStatement, (new SearchParams())->sort(), $pagination->getCurrent(), $height, "Accepted");
